...
namespace Lab2_Part4
{
    ...
    {
        List<Note> PhoneNote;
        public SearchAdressForm(List<Note> _PhoneNote)
        {
            InitializeComponent();
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (Note MyRecord in PhoneNote)
            {
                ...
                if (MyRecord.LastName.Contains(StreetTextBox.Text) &&
                MyRecord.Name.Contains(HouseTextBox.Text) && MyRecord.Patronymic.Contains(FlatTextBox.Text))
                {
